...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pygix-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14102&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pygix-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pygix` can be installed with:

```
conda install pygix
```

It is possible to list all of the versions of `pygix` available on your platform with:
